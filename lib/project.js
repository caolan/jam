...
exports.includeRequireJsConfig = function(requireOpts, dataInclude){
    var optsSrc = JSON.stringify(requireOpts, null, 4);
    dataInclude = dataInclude || "\n    \"packages\": jam.packages,\n    \"shim\": jam.shim,\n";
    return [optsSrc.slice(0, 1), dataInclude, optsSrc.slice(1)].join('');
};
...
exports.mergeShim = function(requireOptsShim, jamShim){
