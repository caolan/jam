...
exports.updateRequireConfig = function (package_dir, baseurl, tree, callback) {
    console.log(['updateRequireConfig', package_dir, baseurl, tree]);
    var packages = [];
    var shims = {};
    ...
    for (var name in tree) {
        if (name !== '_root') {
            ...
            var val = {
                name: name,
                location: dir + '/' + encodeURIComponent(name)
            };
