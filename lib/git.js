        ...
        async.parallel(
            ...
            function(err, result) {
                ...
                if (commitish.length > 1) {
                    logger.warning('Multiple refs was found for the commitish "' + spec + '": ' + commitish.pluck('type').join(', ') + '. Getting first one');
                }

                commitish = _.first(commitish);
