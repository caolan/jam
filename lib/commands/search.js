...
exports.run = function (settings, args, commands) {
    ...
    if (opt.github) {
        ...
        exports.searchRepositories(settings, repos, q, limit);
    }
};


exports.searchRepositories = function (settings, repos, q, limit) {
    var total = 0;
    async.forEachLimit(repos, 4, function (repo, cb) {
        repository.search(settings, repo, q, limit, function (err, data) {
            if (repos.length > 1) {
                console.log(
                    logger.bold('\n' + logger.magenta(
