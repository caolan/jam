...
exports.run = function (settings, args) {
    ...
    exports.initDir(opt, function (err, opt, cfg) {
        ...
        async.reduce(a.positional, null, function (acc, pkg, cb) {
...
exports.installFile = function (cfg, filename, opt, callback) {
    exports.prepareFile(filename, function (err, filecfg, tdir, tfile) {
        ...
        cfg.dependencies[filecfg.name] = null;
        var sources = [
            exports.dirSource(opt.target_dir),
            exports.repoSource(opt.repositories)
        ];
...
exports.installURL = function (cfg, url, opt, callback) {
    ...
    repository.download(url, function (err, filename) {
        ...
        exports.installFile(cfg, filename, opt, callback);
    });
};
