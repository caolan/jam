...
// TODO:
// - jam install <project-dir>
// - jam install <name>    (need to check if package or task)
// - jam install <tarball> (need to check if package or task)
// - jam install <url>     (need to check if package or task)
 ...
 * repositories in the opt object, then loads package.json for the directory
...
/**
 * Install a dependencies for a package directory. Reads the .jamrc and
 * package.json files for that project and checks it's dependencies.
 *
