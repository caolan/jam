...
exports.extend = function (pkg, sources, packages, callback) {
    ...
    if (pkg.source !== 'root') {
        ...
        exports.addVersion(packages[name], _.extend({ version: version }, pkg));
...
exports.addVersion = function(pkg, version) {
    var existing;
    ...
    existing.push.apply(existing, _.filter(version, function(version) {
